...
if __name__ == '__main__':
    ...
    matrix = [[ 0.0212,  0.0080, -0.0208, -0.0086,  0.0150, 0.0036,  0.0078],
    ...
    multi_plot_accuracy([baseline, add, P_rosenbaum, P_random_2], [baseline_label, add_label, P_rosenbaum_label, P_random_label_2], save_dir=os.getcwd())
