...
class ComplexSynapseFast(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(ComplexSynapseFast, self).__init__()
    ...
    def init_parameters(self, params: dict = {}):
        ...
        if self.options.y_vector == yVectorEnum.last_one:
            self.y_vector[-1] = 1
            ...
            if self.adaptionPathway in name:
                ...
                if parameter.adapt == self.adaptionPathway and "weight" in name:
                    ...
                    if (
                        ...
                        or self.operator == operatorEnum.sub
                    ...
                    elif self.operator == operatorEnum.sub or self.operator:
