...
def chemical_upscale():
    load_model = (
        os.getcwd() + "/results_4/mode_9_rand/0/20251105-152312"#"/results_3/mode_9_scalar_9_chems_100/0/20260423-234050"
    ...
    indices_converter = [0, 2, 4, 6, 8] # [0, 1, 2, 3, 4 ,5, 6, 7, 8]  # [0, 1, 3, 4, 6, 7, 9, 10, 12]  # [0, 2, 4, 6, 8]  # [0, 1, 3, 4, 6, 7, 9, 10, 12]
    ...
    save_model_path = os.getcwd() + "/results_4/mode_9_converted_9_chems"
