...
def chemical_upscale():
    load_model = os.getcwd() + "/results_3/mode_9_scalar_10/1/20251124-005417"
    ...
    save_model_path = os.getcwd() + "/results_3/mode_9_scalar_converted_9_chems"
